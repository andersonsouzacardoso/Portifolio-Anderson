    ...
    return(
        <div className="conteudo">
                ...
                <p>Sou um desenvolvedor front-end apaixonado por criar experiências digitais envolventes e responsivas.
                    Com uma formação sólida em design de interface de usuário e uma experiência de trabalho diversificada,
                     estou comprometido em transformar conceitos criativos em códigos funcionais e visualmente impressionantes.
                      ...
                      <p>Certificado em Desenvolvimento Web (Escola estadual Protasio Alves)</p><a className="teste" href="https://drive.google.com/drive/folders/1Fjxsh9YpbOR8Cdb4ibJ2u_5WBDXF2XaX"target="_blank">Clique aqui</a>
                      <p>Certificado em Desenvolvimento Web (Instituto Nu by Descomplica.)</p><a className="teste" href="https://drive.google.com/drive/folders/1cPnvjzEkq2fznstQPVqFuz9Elma9z_Ol"target="_blank">Clique aqui</a>
            ...
            <div className="logos">
                ...
                <img className="logos" src="https://cdn.iconscout.com/icon/free/png-256/free-react-1-282599.png?f=webp" alt="logo React" />
                <img src="https://cdn.icon-icons.com/icons2/17/PNG/256/social_html5_1970.png" alt="logo Html 5" />
                <img src="https://cdn.iconscout.com/icon/free/png-256/free-css3-11-1175239.png" alt="logo Css 3" />
                <img src="https://cdn.iconscout.com/icon/free/png-256/free-git-19-1175220.png" alt="logo Git" />
            </div>
            </div>
